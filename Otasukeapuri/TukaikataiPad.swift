                    ...
                    VStack(spacing: 0){
                        ...
                        ScrollView{
                            ...
                            HStack{
                                ...
                                Text("アイデアの保存時に「寝かせる」を選んだアイデアはここでみることができます。しばらく時間と距離をとって再びアイデアを見た時にどのように感じるかを大切にしましょう。")
                                    .font(.custom("HannariMincho-Regular", size: 15))
                                    .lineSpacing(12)
                                    .foregroundColor(.white) // 文字色
                                    .frame(width: 500)
                            ...
                            HStack{
                                ...
                                Text("アイデアが出ない時、頭を柔らかくしたい時のための場所です。\n１ワードガチャ…３つのワードを組み合わせて一つの文章を作り出すガチャです。ヘンテコな文章も出来上がるのでゲーム感覚で息抜きにも使っていただけます。全部で25万通りの文章が作ることができます。\n２思考方法…アイデア出しに役立つ３つの思考方法を紹介しています。\nこの二つの機能でアイデア出しの手助けを行います。")
                                    .font(.custom("HannariMincho-Regular", size: 15))
                                    .lineSpacing(12)
                                    .foregroundColor(.white) // 文字色
                                    .frame(width: 500)
